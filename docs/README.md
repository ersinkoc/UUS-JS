# Uus.js Documentation

Welcome to the Uus.js documentation! Uus.js is a fresh, lightweight reactive HTML framework that makes building interactive web applications simple and enjoyable.
...
- [Event Handling](./core/events.md) - Handling user interactions
...
- [Showcase](./community/showcase.md) - Apps built with Uus.js

## 🚀 Quick Links

- **GitHub**: [github.com/uus-js/uus](https://github.com/uus-js/uus)
- **Discord**: [Join our community](https://discord.gg/uusjs)
- **Twitter**: [@uusjs](https://twitter.com/uusjs)
- **Blog**: [blog.uusjs.dev](https://blog.uusjs.dev)

## 📖 Reading Order

If you're new to Uus.js, we recommend reading the documentation in this order:

1. [Introduction](./introduction.md) - Understand what Uus.js is
2. [Quick Start](./quick-start.md) - See it in action
3. [Reactivity](./core/reactivity.md) - Learn the core concept
4. [Directives](./core/directives.md) - Master the directives
5. [Tutorial](./tutorial.md) - Build a complete app

## 🎯 Framework Philosophy

Uus.js follows these core principles:

- **Minimal**: < 3KB core, load only what you need
- **Progressive**: Start simple, scale as needed
- **Reactive**: Automatic UI updates
- **Declarative**: Express intent in HTML
- **Fast**: Optimized for performance

## 💡 Getting Help

- Check the [FAQ](./faq.md) for common questions
- Search [existing issues](https://github.com/uus-js/uus/issues)
