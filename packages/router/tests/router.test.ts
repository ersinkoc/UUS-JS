  ...
  describe('Route resolution', () => {
    ...
    it('should warn when navigating to non-existent route', () => {
      ...
      expect(warnSpy).toHaveBeenCalledWith(
        'No route found for path: /non-existent'
      );
...
describe('Router directives', () => {
  ...
  describe('router directive', () => {
    ...
    it('should render initial route', () => {
      ...
      const homeEl = element.querySelector(
        '[data-route-path="/"]'
      ) as HTMLElement;
      const aboutEl = element.querySelector(
        '[data-route-path="/about"]'
      ) as HTMLElement;
    ...
    it('should update on route change', () => {
      ...
      const homeElBefore = element.querySelector(
        '[data-route-path="/"]'
      ) as HTMLElement;
      const aboutElBefore = element.querySelector(
        '[data-route-path="/about"]'
      ) as HTMLElement;
    ...
    it('should handle parameterized routes', () => {
      ...
      const userEl = element.querySelector(
        '[data-route-path="/user/:id"]'
      ) as HTMLElement;
